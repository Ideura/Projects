...
# GNU Fortran
#
t2sub -q S -N ROMS-CORAL -l select=20:ncpus=24:mpiprocs=24:mem=40gb -l place=scatter -l walltime=6:00:00 -et 1  -p 0 -W group_list=t2gnakamulab ./runS_nested_3g.sh
#
# PGI Fortran + GPU
#
